...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 1001, 'lifecycle', 'create', 'Inbox message created.', pObject);
END;
$$ LANGUAGE plpgsql;
...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 1002, 'lifecycle', 'open', 'Inbox message opened.', pObject);
END;
$$ LANGUAGE plpgsql;
...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 1003, 'lifecycle', 'edit', 'Inbox message updated.', pObject);
END;
$$ LANGUAGE plpgsql;
...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 1004, 'lifecycle', 'save', 'Inbox message saved.', pObject);
END;
$$ LANGUAGE plpgsql;
...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 2001, 'workflow', 'enable', 'Inbox message reviewed.', pObject);
END;
$$ LANGUAGE plpgsql;
...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 2002, 'workflow', 'disable', 'Inbox message read.', pObject);
END;
$$ LANGUAGE plpgsql;
...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 2003, 'workflow', 'delete', 'Inbox message deleted.', pObject);
END;
$$ LANGUAGE plpgsql;
...
AS $$
BEGIN
  PERFORM WriteToEventLog('M', 2004, 'workflow', 'restore', 'Inbox message restored.', pObject);
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  ...
  PERFORM WriteToEventLog('W', 2005, 'workflow', 'drop', 'Inbox message dropped.', pObject);
END;
$$ LANGUAGE plpgsql;
