...
Ключ | Тип | Описание
------------ | ------------ | ------------
locale | STRING | **Необязательный**. Код локализаций (`ru`, `en`) для установки по умолчанию.
area | STRING | **Необязательный**. Код зоны (подразделения) для установки по умолчанию.
interface | STRING | **Необязательный**. Код интерфейса для установки по умолчанию.
...
* Параметры запроса для действия [_установить_](#действие-установить).
