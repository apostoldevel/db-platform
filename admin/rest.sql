...
BEGIN
  ...
  WHEN '/admin/verification/email/code' THEN
  ...
  WHEN '/admin/verification/phone/code' THEN
  ...
  WHEN '/admin/verification/email/try' THEN
  ...
  WHEN '/admin/verification/phone/try' THEN
  ...
  WHEN '/admin/verification/code/get' THEN
  ...
  WHEN '/admin/verification/code/list' THEN
